...
public class ForgotpassOpencart {

    WebDriver driver;

    private static final Logger logger =LogManager.getLogger(ForgotpassOpencart.class);

    public ForgotpassOpencart(WebDriver driver) {
	        this.driver = driver;
